public class BinarySearchRunner {
    public static void main(String[] args) {
        ...
        int idxTest = BinarySearch.iterativeNonRecursiveBinarySearch(arr2, 12);
        int idx2Test = BinarySearch.recursiveBinarySearch(arr2, 0, 14, 12);
        System.out.println(idxTest);
        System.out.println(idx2Test);
        System.out.println("---------");

        idxTest = BinarySearch.iterativeNonRecursiveBinarySearch(arr2, 55);
        idx2Test = BinarySearch.recursiveBinarySearch(arr2, 0, 14, 55);
        System.out.println(idxTest);
        System.out.println(idx2Test);
        System.out.println("---------");
    }
